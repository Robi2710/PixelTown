#include "House.h"
#include "Resources.h"
House::House(const std::string &type, int capacity, int costMoney,
             int costMaterials, int maintenanceCost)
    : Buildings(type, capacity, costMoney, costMaterials),
      maintenanceCost(maintenanceCost),
      lastMaintenaceTime(std::chrono::steady_clock::now()), satisfaction(1.0f) {
}
...
Buildings *House::clone() const { return new House(*this); }
