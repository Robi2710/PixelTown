...
public:
  Factory(const std::string &type, int capacity, int costMoney,
          int costMaterials, const std::string &product, int productionRate,
          int materialGenerationRate, int generationInterval);
